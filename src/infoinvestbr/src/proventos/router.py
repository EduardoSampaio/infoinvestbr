...
@router.get("/data-com/codigo-ativo/{codigo_ativo}", dependencies=[Depends(get_current_user)])
...
@router.get("/data-pagamento/codigo-ativo/{codigo_ativo}", dependencies=[Depends(get_current_user)])
...
@router.get("/data-com/{data_com}", dependencies=[Depends(get_current_user)])
...
@router.get("/data-pagamento/{data_pagamento}", dependencies=[Depends(get_current_user)])
